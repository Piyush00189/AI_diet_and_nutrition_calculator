...
/ notifications_page.py (`state('zoomed')`, falling back to `-zoomed`
or a manual full-screen geometry).
...
class AIHealthTipsPage(ctk.CTk):
    def __init__(self, user_data: dict = None, on_back=None):
        ...
        # bmi_calculator.py / calorie_calculator.py / notifications_page.py:
